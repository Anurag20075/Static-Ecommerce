...
export default function DetailPage() {
  ...
  const selectedColorName = useMemo(() => {
    ...
    if (!product.colorNames || !product.colors) return null;
      ...
      <AnimatePresence>
        {showToast && lastAdded && (
          <motion.div
            ...
            className="fixed top-20 left-1/2 z-[100] bg-neutral-900 text-white px-6 py-4 rounded-sm shadow-2xl flex items-center gap-4 min-w-[340px] max-w-[92vw]"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                onClick={dismissToastAndGoToCart}
            ...
            <button
              ...
              className="text-neutral-500 hover:text-white transition-colors flex-shrink-0 self-start"
            >
              <X className="w-4 h-4" />
            </button>
          </motion.div>
