...
//         content: "Complimentary standard shipping. Easy 14-day returns."
//       }
//     ]
//   };

//   const related = [
//     { id: 2, name: "Ribbed Turtleneck Sweater", category: "Knitwear", price: 85.00 },
//     { id: 3, name: "Wide-Leg Tailored Trouser", category: "Bottoms", price: 120.00 },
//     { id: 4, name: "Minimal Leather Crossbody", category: "Accessories", price: 155.00 },
//   ];
...
//   if (!passedProduct && !product.image) {
//     return (
//       <div className="min-h-screen flex items-center justify-center flex-col gap-4">
//         <p className="text-neutral-500 tracking-wider">Product not found.</p>
//         <button onClick={() => navigate('/shop')} className="underline text-black">Go Back to Shop</button>
//       </div>
//     );
//   }
...
export default function DetailPage() {
  ...
  // Fallback data if accessed directly via URL
  const product = passedProduct || {
    id: 1,
    name: "Oversized Wool Blend Coat",
    category: "Outerwear / Fall Collection",
  ...
  // Combines men's and women's data, removes the current product, and picks 4
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-sans antialiased pb-24 lg:pb-0">
      ...
      <div className="fixed bottom-0 left-0 right-0 border-t border-neutral-200 bg-white/95 backdrop-blur-md p-4 z-50 flex gap-3 items-center sm:hidden">
        ...
        <button 
          onClick={handleAddToCart}
          className={`flex-1 text-center text-white text-xs tracking-widest uppercase py-4 font-medium transition-colors flex items-center justify-center gap-2 ${
