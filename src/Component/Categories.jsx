...
//     // Group the grid items so the PromoBanner appears after the 8th item
//     const gridItems = [...filteredProducts];
//     gridItems.splice(8, 0, { isPromo: true, id: "promo-banner" });
...
//                 {/* Category Toggles & Filters */}
//                 <div className="flex flex-wrap items-center justify-between gap-4 mb-8 pb-4 border-b border-gray-200">
//                     <div className="flex items-center gap-2">
//                         <button 
//                             onClick={() => setActiveCategory("all")}
//                             className={`px-4 py-2 text-sm font-medium transition-colors ${activeCategory === 'all' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:text-black border border-gray-200'}`}>
//                             All
//                         </button>
//                         <button 
//                             onClick={() => setActiveCategory("men")}
//                             className={`px-4 py-2 text-sm font-medium transition-colors ${activeCategory === 'men' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:text-black border border-gray-200'}`}>
//                             Men
//                         </button>
//                         <button 
//                             onClick={() => setActiveCategory("women")}
//                             className={`px-4 py-2 text-sm font-medium transition-colors ${activeCategory === 'women' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:text-black border border-gray-200'}`}>
//                             Women
//                         </button>
                        
//                         <button className="lg:hidden flex items-center gap-2 px-4 py-2 bg-gray-100 text-black text-sm font-medium rounded-sm ml-2">
...
//                 {/* Product Grid linking live global system handler */}
//                 <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-12">
//                     {gridItems.map((item) =>
//                         item.isPromo ? (
//                             <PromoBanner key={item.id} />
//                         ) : (
//                             <ProductCard
//                                 key={item.id}
//                                 product={item}
...
//                         </h2>
//                         <div className="flex items-center gap-2">
//                             <span className="text-xs font-semibold uppercase tracking-wider mr-2 hidden sm:block">
    ...
    >
        <div className="flex flex-col flex-grow">
            <div className="relative aspect-[3/4] bg-gray-100 mb-4 overflow-hidden rounded-sm">
                ...
                {/* Gender badge when viewing all */}
                {product.gender && (
                    <span
                        className={`absolute bottom-3 left-3 text-[9px] font-bold px-2 py-0.5 tracking-widest z-10 uppercase ${
        ...
        <div>
            <div className="aspect-[3/4] bg-gray-100 mb-3 overflow-hidden rounded-sm relative">
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-300 flex items-end justify-center pb-4 opacity-0 group-hover:opacity-100">
                    <span className="bg-white text-black text-[10px] font-semibold tracking-wider px-4 py-2">
                        QUICK ADD
                    </span>
                </div>
            </div>
